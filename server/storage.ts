...
export class DatabaseStorage implements IStorage {
  ...
  async initializeTestData(userId: string): Promise<void> {
    ...
    // Create test bank accounts and other assets
    ...
    await db.insert(userSettings).values({
      ...
      bithumbGrade: 'white',
      defaultFeeRates: {
        'Bithumb': { purchase: 0.0004, transfer: 0 },
        'Upbit': { purchase: 0.0005, transfer: 0.0005 },
        'Binance': { purchase: 0.001, transfer: 0.001 }
      }
    });
  }
}
